...
大企業に新しいプロセス、ましてや新しい文化を導入するには、優れた戦略、役員の賛同、強力な伝道、簡単な採用パターン、そして何より忍耐が必要である。
SLOのような大きな変化が会社に定着するには、何年もかかるかもしれない。
Home Depotは伝統的な企業だということを強調したい。このような大きな変化をうまく導入できれば、あなたにもできます。
