...
大企業に新しいプロセス、ましてや新しい文化を導入するには、優れた戦略、役員の賛同、強力な伝道、簡単な採用パターン、そして何より忍耐が必要です。
SLOのような大きな変化が会社に定着するには、何年もかかるかもしれません。
Home Depotは伝統的な企業だということを強調したいです。このような大きな変化をうまく導入できれば、あなたにもできます。
また、このタスクに一度に取り組む必要もありません。
SLOは段階的に実装しましたが、包括的な伝道戦略と明確なインセンティブ構造を開発することで、迅速な変革が可能になりました。SLOがサポートするサービスは、0から800になりました。
